export default [
    ...
    },
    {
      ...
      },
      {
        id: "14",
        title: "Ford Mondeo",
        description: "A family/friend requested if I could install a Reversing Camera for his Ford Mondeo. The challenge with this vehicle was that he wanted to keep the OEM radio, while also using the camera in the radio. Unfortunatly this work could not be done at my work which. I also did this work in my own time as he installed an external tap for my so I can clean my cars for free - hence the favour being returned.",
