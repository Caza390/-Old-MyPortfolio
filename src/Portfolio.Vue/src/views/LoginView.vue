...
<body>
    <div class="flex justify-center items-center h-screen bg-woodsmoke-950">
        <div class="w-96 p-6 shadow-lg bg-white rounded-md">
            ...
            <div class="mt-1">
                <p class="text-woodsmoke-400 text-center">Please use the login details that have been given to you</p>
            </div>
            <hr class="mt-3">
            <div class="mt-3">
            ...
            <div class="mt-3 flex justify-between items-center">
                ...
                <div>
                    <RouterLink to="/home" class="border-2 border-coral-red-700 bg-coral-red-50 text-coral-red-700 py-1 px-5 rounded-md hover:bg-coral-red-100 hover:text-coral-red-700 hover:border-coral-red-700">Login</RouterLink>
                </div>
            </div>
        </div>
    </div>
